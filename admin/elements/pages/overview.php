            ...
            <?php foreach ($dirContents as $dirContentsKey => $dirContentsValue) {
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="heading-<?php echo $dirContentsKey ?>">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $dirContentsKey ?>" aria-controls="collapse-<?php echo $dirContentsKey ?>">
                            <h5>
                                <?php echo $language[$dirContentsKey]; ?>
                            </h5>
                        </button>
                    </h2>
                    <div id="collapse-<?php echo $dirContentsKey ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?php echo $dirContentsKey ?>" data-bs-parent="#accordion-status">
                        <div class="accordion-body">
                            <div class="accordion" id="accordion-<?php echo $dirContentsKey ?>">
                                ...
                                foreach ($dirContentsValue as $dirContent) {
                                    ...
                                    ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-<?php echo $iniContent["CRON"]["cron_id"] ?>">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $iniContent["CRON"]["cron_id"] ?>" aria-controls="collapse-<?php echo $iniContent["CRON"]["cron_id"] ?>">
                                                <h5>
                                                    <?php echo $language["BACKUP_PATH"] . ": " . $iniContent["DIRECTADMIN_WWW"]["directadmin_backup_path"] ?>
                                                </h5>
                                            </button>
                                        </h2>
                                        <div id="collapse-<?php echo $iniContent["CRON"]["cron_id"] ?>" class="accordion-collapse collapse" aria-labelledby="heading-<?php echo $iniContent["CRON"]["cron_id"] ?>" data-bs-parent="#accordion-<?php echo $dirContentsKey ?>">
                                            <div class="accordion-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <ul class="list-group">
                                                    ...
                                                    <div class="col">
                                                        <ul class="list-group">
                                                            <li class="list-group-item">
                                                                <?php echo $language["SEND_EMAIL_NOTIFICATIONS"] . ": "; if ($iniContent["EMAIL"]["send_email_enabled"] == "1") { echo $language["ENABLED"];} else {echo $language["DISABLED"];}?>
                                                            </li>
                                                            <li class="list-group-item">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <ul class="list-group">
                                                            <li class="list-group-item">
                                                                <a href="index.html?tab=create&cron_id=<?php echo $iniContent["CRON"]["cron_id"] ?>&cron_state=<?php echo $dirContentsKey; ?>" class="btn btn-primary" role="button"><?php echo $language["EDIT"]; ?></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
